...
For example, if lst was [23, 42, 108], the function should return [23, 42, 108, 3] 
because the size of lst was originally 3.
'''
# other function of challenge
def append_size(lst):
  lst.append(len(lst))#add he len of the list to the end
  return lst
